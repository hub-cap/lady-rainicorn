...
from rainicorn.openstack.common import loopingcall
from rainicorn.openstack.common import rpc as openstack_rpc
from rainicorn.openstack.common.rpc import service as rpc_service
...
class RpcService(rpc_service.Service):
    ...
    def __init__(self, host=None, binary=None, topic=None, manager=None):
        ...
        topic = topic or binary.rpartition('rainicorn-')[2]
