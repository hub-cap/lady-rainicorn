...
common_opts = [
    cfg.StrOpt('sql_connection',
               default='sqlite:///rainicorn_test.sqlite',
               help='SQL Connection'),
    ...
    cfg.StrOpt('api_paste_config',
               ...
               help='File name for the paste.deploy config for rainicorn-api'),
    cfg.BoolOpt('add_addresses',
                default=False,
                help='Whether to add IP addresses to the list operations'),
    cfg.BoolOpt('rainicorn_volume_support',
                default=True,
                help='File name for the paste.deploy config for rainicorn-api'),
    ...
    cfg.StrOpt('rainicorn_auth_url', default='http://0.0.0.0:5000/v2.0'),
    ...
    cfg.BoolOpt('rainicorn_dns_support', default=False),
    cfg.StrOpt('db_api_implementation', default='rainicorn.db.sqlalchemy.api'),
    cfg.StrOpt('mysql_pkg', default='mysql-server-5.5'),
    cfg.StrOpt('percona_pkg', default='percona-server-server-5.5'),
    cfg.StrOpt('dns_driver', default='rainicorn.dns.driver.DnsDriver'),
    cfg.StrOpt('dns_instance_entry_factory',
               default='rainicorn.dns.driver.DnsInstanceEntryFactory'),
    ...
    cfg.StrOpt('quota_driver',
               default='rainicorn.quota.quota.DbQuotaDriver',
    ...
    cfg.BoolOpt('rainicorn_security_groups_support', default=True),
    cfg.StrOpt('rainicorn_security_group_rule_protocol', default='tcp'),
    cfg.IntOpt('rainicorn_security_group_rule_port', default=3306),
    cfg.IntOpt('rainicorn_api_workers', default=None),
    ...
    cfg.StrOpt('backup_runner',
               default='rainicorn.guestagent.backup.backup_types.InnoBackupEx'),
    cfg.StrOpt('backup_strategy', default='InnoBackupEx',
               help='Default strategy to perform backups'),
    cfg.StrOpt('backup_namespace',
               default='rainicorn.guestagent.strategies.backup.impl',
               help='Namespace to load backup strategies from'),
    cfg.StrOpt('restore_namespace',
               default='rainicorn.guestagent.strategies.restore.impl',
    ...
    cfg.StrOpt('storage_namespace',
               default='rainicorn.guestagent.strategies.storage.swift',
    ...
    cfg.StrOpt('remote_dns_client',
               default='rainicorn.common.remote.dns_client'),
    cfg.StrOpt('remote_guest_client',
               default='rainicorn.common.remote.guest_client'),
    cfg.StrOpt('remote_nova_client',
               default='rainicorn.common.remote.nova_client'),
    cfg.StrOpt('remote_nova_volume_client',
               default='rainicorn.common.remote.nova_volume_client'),
    cfg.StrOpt('remote_swift_client',
               default='rainicorn.common.remote.swift_client'),
